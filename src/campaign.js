...
const campaignMetadata=[
 ...
 {title:'月光归档',sub:'06 / THE MOON ARCHIVE',mechanics:'画中路 · 观测椅 · 回声与光',goal:'穿入幕布，坐下看月亮，让回声与月光同时留在庭院。',intro:'第六章 · 月光归档。用留白进入画中，再把最后一个视点带回现实。'}
];
CAMPAIGN.forEach((raw,i)=>Object.assign(chapters[raw],campaignMetadata[i]));
chapters[7].hints.unshift('先缩小入口的三点方块：E 拿起，− 拉近到 ≤ 0.70 m，放在锚点中心松手。圆环亮起后，花园才会记住正确路线。');
